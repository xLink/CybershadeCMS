...
class Form extends coreObj {
    ...
    public function start($name, $args = array()){
        ...
        $params = array( &$args );
        coreObj::getPlugins()->hook('CMS_FORM_START_ARGS', $params);
    ...
    public function inputBox($name, $type='text', $value='', $args=array()){
        ...
        // setup a hook for the args
        $params = array( &$args );
        coreObj::getPlugins()->hook('CMS_FORM_INPUTBOX_ARGS', $params);
    ...
    public function textarea($name='textarea', $value=null, $args=array()){
        ...
        // setup a hook for the args
        $params = array( &$args );
        coreObj::getPlugins()->hook('CMS_FORM_TEXTAREA_ARGS', $params);
        ...
        $pluginExtras = coreObj::getPlugins()->hook('CMS_FORM_TEXTAREA_EXTRAS');
    ...
    public function radio($name='radio', $values=array(), $defaultSetting=null, $args=array()){
        ...
        // setup a hook for the args
        $params = array( &$args );
        coreObj::getPlugins()->hook('CMS_FORM_RADIO_ARGS', $params);
    ...
    public function checkbox($name='check', $value='', $checked=false, $args=array()){
        ...
        // setup a hook for the args
        $params = array( &$args );
        coreObj::getPlugins()->hook('CMS_FORM_CHECKBOX_ARGS', $params);
    ...
    public function select($name, $options, $args=array()){
        ...
        // setup a hook for the args
        $params = array( &$args );
        coreObj::getPlugins()->hook('CMS_FORM_SELECT_ARGS', $params);
