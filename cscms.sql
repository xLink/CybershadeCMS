...
-- Dumping structure for table cscms.cscms_article_cats
...
-- Dumping data for table cscms.cscms_article_cats: ~5 rows (approximately)
DELETE FROM `cscms_article_cats`;
/*!40000 ALTER TABLE `cscms_article_cats` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `cscms_article_cats` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_article_content
...
CREATE TABLE IF NOT EXISTS `cscms_article_content` (
  ...
  PRIMARY KEY (`id`),
  KEY `cat_id` (`cat_id`),
  CONSTRAINT `cscms_article_content_ibfk_1` FOREIGN KEY (`cat_id`) REFERENCES `cscms_article_cats` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=latin1;

-- Dumping data for table cscms.cscms_article_content: ~4 rows (approximately)
DELETE FROM `cscms_article_content`;
/*!40000 ALTER TABLE `cscms_article_content` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `cscms_article_content` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_blocks
...
-- Dumping data for table cscms.cscms_blocks: ~1 rows (approximately)
DELETE FROM `cscms_blocks`;
/*!40000 ALTER TABLE `cscms_blocks` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `cscms_blocks` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_blocks_routes
...
-- Dumping data for table cscms.cscms_blocks_routes: ~0 rows (approximately)
DELETE FROM `cscms_blocks_routes`;
/*!40000 ALTER TABLE `cscms_blocks_routes` DISABLE KEYS */;
/*!40000 ALTER TABLE `cscms_blocks_routes` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_config
...
-- Dumping data for table cscms.cscms_config: ~17 rows (approximately)
DELETE FROM `cscms_config`;
/*!40000 ALTER TABLE `cscms_config` DISABLE KEYS */;
INSERT INTO `cscms_config` (`key`, `var`, `value`) VALUES
	...
	('site', 'title', 'CSDev'),
	('time', 'timezone', '0');
/*!40000 ALTER TABLE `cscms_config` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_forum_cats
...
CREATE TABLE IF NOT EXISTS `cscms_forum_cats` (
  ...
  CONSTRAINT `cscms_forum_cats_ibfk_1` FOREIGN KEY (`parent_id`) REFERENCES `cscms_forum_cats` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;

-- Dumping data for table cscms.cscms_forum_cats: ~0 rows (approximately)
DELETE FROM `cscms_forum_cats`;
/*!40000 ALTER TABLE `cscms_forum_cats` DISABLE KEYS */;
/*!40000 ALTER TABLE `cscms_forum_cats` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_forum_posts
...
CREATE TABLE IF NOT EXISTS `cscms_forum_posts` (
  ...
  CONSTRAINT `cscms_forum_posts_ibfk_1` FOREIGN KEY (`thread_id`) REFERENCES `cscms_forum_threads` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;

-- Dumping data for table cscms.cscms_forum_posts: ~0 rows (approximately)
DELETE FROM `cscms_forum_posts`;
/*!40000 ALTER TABLE `cscms_forum_posts` DISABLE KEYS */;
/*!40000 ALTER TABLE `cscms_forum_posts` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_forum_threads
...
CREATE TABLE IF NOT EXISTS `cscms_forum_threads` (
  ...
  PRIMARY KEY (`id`),
  KEY `cat_id` (`cat_id`),
  CONSTRAINT `cscms_forum_threads_ibfk_1` FOREIGN KEY (`cat_id`) REFERENCES `cscms_forum_cats` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;

-- Dumping data for table cscms.cscms_forum_threads: ~0 rows (approximately)
DELETE FROM `cscms_forum_threads`;
/*!40000 ALTER TABLE `cscms_forum_threads` DISABLE KEYS */;
/*!40000 ALTER TABLE `cscms_forum_threads` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_forum_watch
...
CREATE TABLE IF NOT EXISTS `cscms_forum_watch` (
  ...
  KEY `uid` (`uid`),
  KEY `thread_id` (`thread_id`),
  CONSTRAINT `cscms_forum_watch_ibfk_1` FOREIGN KEY (`thread_id`) REFERENCES `cscms_forum_threads` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table cscms.cscms_forum_watch: ~0 rows (approximately)
DELETE FROM `cscms_forum_watch`;
/*!40000 ALTER TABLE `cscms_forum_watch` DISABLE KEYS */;
/*!40000 ALTER TABLE `cscms_forum_watch` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_groups
...
-- Dumping data for table cscms.cscms_groups: ~4 rows (approximately)
DELETE FROM `cscms_groups`;
/*!40000 ALTER TABLE `cscms_groups` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `cscms_groups` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_groups_perms
...
CREATE TABLE IF NOT EXISTS `cscms_groups_perms` (
  ...
  CONSTRAINT `cscms_groups_perms_ibfk_1` FOREIGN KEY (`permission_key`) REFERENCES `cscms_permissions` (`key`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `cscms_groups_perms_ibfk_2` FOREIGN KEY (`group_id`) REFERENCES `cscms_groups` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table cscms.cscms_groups_perms: ~34 rows (approximately)
DELETE FROM `cscms_groups_perms`;
/*!40000 ALTER TABLE `cscms_groups_perms` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `cscms_groups_perms` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_groups_subs
...
CREATE TABLE IF NOT EXISTS `cscms_groups_subs` (
  ...
  KEY `group_id` (`group_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `cscms_groups_subs_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `cscms_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `cscms_groups_subs_ibfk_2` FOREIGN KEY (`group_id`) REFERENCES `cscms_groups` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table cscms.cscms_groups_subs: ~3 rows (approximately)
DELETE FROM `cscms_groups_subs`;
/*!40000 ALTER TABLE `cscms_groups_subs` DISABLE KEYS */;
INSERT INTO `cscms_groups_subs` (`user_id`, `group_id`, `pending`) VALUES
	(1, 4, '0'),
	(2, 3, '0'),
	(2, 1, '0');
/*!40000 ALTER TABLE `cscms_groups_subs` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_menus
...
-- Dumping data for table cscms.cscms_menus: ~30 rows (approximately)
DELETE FROM `cscms_menus`;
/*!40000 ALTER TABLE `cscms_menus` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `cscms_menus` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_modules
...
-- Dumping data for table cscms.cscms_modules: ~0 rows (approximately)
DELETE FROM `cscms_modules`;
/*!40000 ALTER TABLE `cscms_modules` DISABLE KEYS */;
/*!40000 ALTER TABLE `cscms_modules` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_permissions
...
-- Dumping data for table cscms.cscms_permissions: ~9 rows (approximately)
DELETE FROM `cscms_permissions`;
/*!40000 ALTER TABLE `cscms_permissions` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `cscms_permissions` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_plugins
...
-- Dumping data for table cscms.cscms_plugins: ~2 rows (approximately)
DELETE FROM `cscms_plugins`;
/*!40000 ALTER TABLE `cscms_plugins` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `cscms_plugins` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_routes
...
-- Dumping data for table cscms.cscms_routes: ~11 rows (approximately)
DELETE FROM `cscms_routes`;
/*!40000 ALTER TABLE `cscms_routes` DISABLE KEYS */;
INSERT INTO `cscms_routes` (`id`, `module`, `label`, `method`, `pattern`, `arguments`, `requirements`, `status`, `redirect`) VALUES
	...
	(11, 'a74ad8dfacd4f985eb3977517615ce25', 'core_registerForm_process', 'POST', '/register', '{"module":"Modules_core", "method":"registerUserProcess"}', '[]', 1, NULL),
	(12, 'a74ad8dfacd4f985eb3977517615ce25', 'core_forgotPasswordForm', 'GET', '/forgotpass', '{"module":"Modules_core", "method":"forgotPasswordForm"}', '[]', 1, NULL),
	(13, 'a74ad8dfacd4f985eb3977517615ce25', 'core_forgotPasswordForm_process', 'POST', '/forgotpass', '{"module":"Modules_core", "method":"forgotPasswordFormProcess"}', '[]', 1, NULL);
/*!40000 ALTER TABLE `cscms_routes` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_sessions
...
-- Dumping data for table cscms.cscms_sessions: ~1 rows (approximately)
DELETE FROM `cscms_sessions`;
/*!40000 ALTER TABLE `cscms_sessions` DISABLE KEYS */;
INSERT INTO `cscms_sessions` (`uid`, `sid`, `hostname`, `timestamp`, `useragent`, `mode`, `admin`, `login_time`, `login_attempts`, `store`) VALUES
	(0, '5c6df62c743cc5b636f8aea15ae71e8b', '127.0.0.1', 1367266906, 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:20.0) Gecko/20100101 Firefox/20.0', 'active', 0, 0, 0, _binary 0x613A313A7B733A343A2275736572223B613A313A7B733A393A2274696D657374616D70223B693A313336373236323731303B7D7D);
/*!40000 ALTER TABLE `cscms_sessions` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_uploads
...
-- Dumping data for table cscms.cscms_uploads: ~0 rows (approximately)
DELETE FROM `cscms_uploads`;
/*!40000 ALTER TABLE `cscms_uploads` DISABLE KEYS */;
/*!40000 ALTER TABLE `cscms_uploads` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_userkeys
...
-- Dumping data for table cscms.cscms_userkeys: ~7 rows (approximately)
DELETE FROM `cscms_userkeys`;
/*!40000 ALTER TABLE `cscms_userkeys` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `cscms_userkeys` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_users
...
-- Dumping data for table cscms.cscms_users: ~2 rows (approximately)
DELETE FROM `cscms_users`;
/*!40000 ALTER TABLE `cscms_users` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `cscms_users` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_users_extras
...
CREATE TABLE IF NOT EXISTS `cscms_users_extras` (
  ...
  CONSTRAINT `cscms_users_extras_ibfk_2` FOREIGN KEY (`uid`) REFERENCES `cscms_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table cscms.cscms_users_extras: ~2 rows (approximately)
DELETE FROM `cscms_users_extras`;
/*!40000 ALTER TABLE `cscms_users_extras` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `cscms_users_extras` ENABLE KEYS */;


-- Dumping structure for table cscms.cscms_users_perms
...
CREATE TABLE IF NOT EXISTS `cscms_users_perms` (
  ...
  KEY `permission_key` (`permission_key`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `cscms_users_perms_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `cscms_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `cscms_users_perms_ibfk_1` FOREIGN KEY (`permission_key`) REFERENCES `cscms_permissions` (`key`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;

-- Dumping data for table cscms.cscms_users_perms: ~0 rows (approximately)
DELETE FROM `cscms_users_perms`;
/*!40000 ALTER TABLE `cscms_users_perms` DISABLE KEYS */;
/*!40000 ALTER TABLE `cscms_users_perms` ENABLE KEYS */;
