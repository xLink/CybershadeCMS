  ...
  * ====================== */
  ...
  Modal.prototype = {
    ...
    , hideModal: function () {
        ...
        this.backdrop(function () {
          that.removeBackdrop()
          that.$element.triggerHandler('hidden')
        })
      }
...
!function ($) {
  ...
  * =============================== */
  ...
  , init: function (type, element, options) {
      ...
      triggerHandlers = this.options.triggerHandler.split(' ')

      for (i = triggerHandlers.length; i--;) {
        triggerHandler = triggerHandlers[i]
        if (triggerHandler == 'click') {
          this.$element.on('click.' + this.type, this.options.selector, $.proxy(this.toggle, this))
        } else if (triggerHandler != 'manual') {
          eventIn = triggerHandler == 'hover' ? 'mouseenter' : 'focus'
          eventOut = triggerHandler == 'hover' ? 'mouseleave' : 'blur'
